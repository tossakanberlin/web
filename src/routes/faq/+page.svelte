...
<div class="flex flex-col md:items-start bg-blue text-white pt-10">
  <div class="flex flex-row md:flex:col justify-center items-center md:items-start sm:ml-10 text-6xl md:text-8xl md:gap-4 font-serif my-5">
		<h2>DATENSCHUTZ</h2>
	</div>
  <div class="flex flex-col md:justify-start items-center md:items-start md:ml-20 gap-8 my-5 mx-5">
    <div class="grid gap-3 text-center md:text-left">
      ...
      <p>(2) Verantwortlicher gem. Art. 4 Abs. 7 EU-Datenschutz-Grundverordnung (DS-GVO) ist die Restaurant Wild & Raue Betriebsgesellschaft mbH, vertreten durch die Geschäftsführerin Marie-Anne Wild, Rudi-Dutschke-Strasse 26, 10969 Berlin, office@tim-raue.com (siehe Impressum).</p>
    ...
    <div class="grid gap-3 text-center md:text-left">
      <p>§ 2 Ihre Rechte</p>
      <p>(1) Sie haben gegenüber uns folgende Rechte hinsichtlich der Sie betreffenden personenbezogenen Daten:– Recht auf Auskunft,– Recht auf Berichtigung oder Löschung,– Recht auf Einschränkung der 
        Verarbeitung,– Recht auf Widerspruch gegen die Verarbeitung,– Recht auf Datenübertragbarkeit.</p>
    ...
    <div class="grid gap-3 text-center md:text-left">
      ...
      <p>
        (3) Selbstverständlich können Sie der Verarbeitung Ihrer personenbezogenen Daten für Zwecke der Werbung und Datenanalyse jederzeit widersprechen.</p>
    </div>
    <div class="grid gap-3 text-center md:text-left">
    ...
    <div class="grid gap-3 text-center md:text-left">
      <p>§ 7 Social Media</p>
      <p>(1) Wir setzen derzeit das Social-Media-Plug-in von Facebook ein. Wir nutzen dabei die sog. Zwei-Klick-Lösung. Das heißt, wenn Sie unsere Seite besuchen, werden zunächst grundsätzlich keine personenbezogenen Daten an die Anbieter der Plug-ins weitergegeben. Den Anbieter des Plug-ins erkennen Sie über die Markierung auf dem Kasten über seinen Anfangsbuchstaben oder das Logo. Wir eröffnen Ihnen die Möglichkeit, über den Button direkt mit dem Anbieter des Plug-ins zu kommunizieren. Nur wenn Sie auf das markierte Feld klicken und es dadurch aktivieren, erhält der Plug-in-Anbieter die Information, dass Sie die entsprechende Website unseres Online-Angebots aufgerufen haben. Zudem werden die unter § 3 dieser Erklärung genannten Daten übermittelt. Im Fall von Facebook wird nach desse Angaben die IP-Adresse sofort nach Erhebung anonymisiert. Durch die Aktivierung des Plug-ins werden also personenbezogene Daten von Ihnen an den jeweiligen Plug-in-Anbieter übermittelt und dort (bei US-amerikanischen Anbietern in den USA) gespeichert.</p>
      ...
      <p>(6) Adressen des Plug-in-Anbieters und URL mit deren Datenschutzhinweisen: Facebook Inc., 1601 S California Ave, Palo Alto, California 94304, USA; http://www.facebook.com/policy.php; weitere Informationen zur Datenerhebung: http://www.facebook.com/help/186325668085084, http://www.facebook.com/about/privacy/yo
        ur-info-on-other#applications sowie http://www.facebook.com/about/privacy/your-info#everyoneinfo. Facebook hat sich dem EU-US-Privacy-Shield unterworfen, https://www.privacyshield.gov/EU-US-Framework.</p>
    </div>
    <div class="grid gap-3 text-center md:text-left">
