	...
	<div class="flex flex-col md:justify-start items-center md:items-start gap-8 my-5 mx-5">
		<div class="grid gap-3 text-center md:text-left">
			...
			<p>
				...
				uns gespeichert, um Ihre Fragen zu beantworten. Die in diesem Zusammenhang anfallenden Daten
		...
		<div class="grid gap-3 text-center md:text-left">
			...
			<p>
				...
				personenbezogenen Daten:– Recht auf Auskunft,– Recht auf Berichtigung oder Löschung,– Recht
				auf Einschränkung der Verarbeitung,– Recht auf Widerspruch gegen die Verarbeitung,– Recht
		...
		<div class="grid gap-3 text-center md:text-left">
			...
			<p>
				...
				Zugriffsstatus/HTTP-Statuscode– jeweils übertragene Datenmenge– Website, von der die
				Anforderung kommt– Browser– Betriebssystem und dessen Oberfläche– Sprache und Version der
				Browsersoftware.
			</p>
			<p>
			...
			<p>
				(3) Einsatz von Cookies: a) Diese Website nutzt folgende Arten von Cookies, deren Umfang und
				Funktionsweise im Folgenden erläutert werden:b) Transiente Cookies werden automatisiert
				gelöscht, wenn Sie den Browser schließen. Dazu zählen insbesondere die Session-Cookies.
				Diese speichern eine sogenannte Session-ID, mit welcher sich verschiedene Anfragen Ihres
				Browsers der gemeinsamen Sitzung zuordnen lassen. Dadurch kann Ihr Rechner wiedererkannt
				werden, wenn Sie auf unsere Website zurückkehren. Die Session-Cookies werden gelöscht, wenn
				Sie sich ausloggen oder den Browser schließen.c) Persistente Cookies werden automatisiert
				nach einer vorgegebenen Dauer gelöscht, die sich je nach Cookie unterscheiden kann. Sie
				können die Cookies in den Sicherheitseinstellungen Ihres Browsers jederzeit löschen.d) Sie
				können Ihre Browser-Einstellung entsprechend Ihren Wünschen konfigurieren und z. B. die
		...
		<div class="grid gap-3 text-center md:text-left">
			...
			<p>
				...
				wurden von uns sorgfältig ausgewählt und beauftragt, sind an unsere Weisungen gebunden und
		...
		<div class="grid gap-3 text-center md:text-left">
			...
			<p>
				...
				Verarbeitung insbesondere nicht zur Erfüllung eines Vertrags mit Ihnen erforderlich ist, was
		...
		<div class="grid gap-3 text-center md:text-left">
			<p>§ 7 Social Media</p>
			<p>
				(1) Wir setzen derzeit das Social-Media-Plug-in von Facebook ein. Wir nutzen dabei die sog.
				...
				das Logo. Wir eröffnen Ihnen die Möglichkeit, über den Button direkt mit dem Anbieter des
				Plug-ins zu kommunizieren. Nur wenn Sie auf das markierte Feld klicken und es dadurch
				aktivieren, erhält der Plug-in-Anbieter die Information, dass Sie die entsprechende Website
				unseres Online-Angebots aufgerufen haben. Zudem werden die unter § 3 dieser Erklärung
				genannten Daten übermittelt. Im Fall von Facebook wird nach desse Angaben die IP-Adresse
				sofort nach Erhebung anonymisiert. Durch die Aktivierung des Plug-ins werden also
				personenbezogene Daten von Ihnen an den jeweiligen Plug-in-Anbieter übermittelt und dort
				(bei US-amerikanischen Anbietern in den USA) gespeichert.
			</p>
			<p>
			...
			<p>
				(3) Der Plug-in-Anbieter speichert die über Sie erhobenen Daten als Nutzungsprofile und
			...
			<p>
				...
				speichert der Plug-in-Anbieter auch diese Information in Ihrem Nutzerkonto und teilt sie
				Ihren Kontakten öffentlich mit.
			</p>
			<p>
			...
			<p>
				(6) Adressen des Plug-in-Anbieters und URL mit deren Datenschutzhinweisen: Facebook Inc.,
				...
				http://www.facebook.com/about/privacy/yo ur-info-on-other#applications sowie
		...
		<div class="grid gap-3 text-center md:text-left">
			<p>§ 8 Einbindung von Google Maps</p>
			<p>
			...
			<p>
				...
				entsprechende Unterseite unserer Website aufgerufen haben. Zudem werden die unter § 3 dieser
				Erklärung genannten Daten übermittelt. Dies erfolgt unabhängig davon, ob Google ein
				Nutzerkonto bereitstellt, über das Sie eingeloggt sind, oder ob kein Nutzerkonto besteht.
				Wenn Sie bei Google eingeloggt sind, werden Ihre Daten direkt Ihrem Konto zugeordnet. Wenn
				Sie die Zuordnung mit Ihrem Profil bei Google nicht wünschen, müssen Sie sich vor
				...
				Website. Eine solche Auswertung erfolgt insbesondere (selbst für nicht eingeloggte Nutzer)
				zur Erbringung von bedarfsgerechter Werbung und um andere Nutzer des sozialen Netzwerks über
				Ihre Aktivitäten auf unserer Website zu informieren. Ihnen steht ein Widerspruchsrecht zu
				gegen die Bildung dieser Nutzerprofile, wobei Sie sich zur Ausübung dessen an Google richten
				müssen.
			</p>
			<p>
